...
struct my_update
{
	...
	void apply(my_node &x, const int32_t &tl, const int32_t &tr)
	{
		...
		// no change in freq
		// 1 range me jo update krna hai wo likho
		// like add z in range wale me x.v+=(r-l+1)*z krte the waise
...
/*
	utkarsh gupta segtree template
	#include "bits/stdc++.h"
using namespace std;
